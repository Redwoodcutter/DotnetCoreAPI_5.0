...
export default function ActivityList({dashboard,selectActivity,deleteActivity}:Props){
    return(
        <Segment>
            <Item.Group divided>
                    ...
                    <Item key={dashboard.id}>
                        <Item.Content>
                            ...
                            <Item.Extra>
                                ...
                                <Button onClick={() => deleteActivity(dashboard.id)} floated='right' content='Delete' color='red'></Button>
